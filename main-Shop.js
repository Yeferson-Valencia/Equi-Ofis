...
//                                 <li><a class="btn btn-success text-white mt-2 image-gallery-add-to-cart" href="#" onclick="addToCartAndRedirect('${encodeURIComponent(path)}', '${encodeURIComponent(nombre)}')"><i class="far fa-eye"></i></a></li>
//                                 <li><a class="btn btn-success text-white mt-2 image-gallery-add-to-cart" href="#" onclick="addToCartAndRedirect('${encodeURIComponent(path)}', '${encodeURIComponent(nombre)}')"><i class="fas fa-cart-plus"></i></a></li>
//                             </ul>
//                         </div>
//                     </div>
//                     <div class="card-body">
